...
<body class="nk-body bg-lighter npc-default has-sidebar ">
    <div class="nk-app-root">
        ...
        <div class="nk-main ">
            ...
            <div class="nk-sidebar nk-sidebar-fixed is-light " data-content="sidebarMenu">
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="{{ route('dashboard')}}" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src="{{ asset('guest/images/logo-dark.png') }}"  alt="logo">
                            <img class="logo-dark logo-img" src="{{ asset('guest/images/logo-dark.png') }}"  alt="logo-dark">
                            <img class="logo-small logo-img logo-img-small" src="{{ asset('guest/images/favicon.png')}}"  alt="logo-small">
                        </a>
                    </div>
                ...
                @include('livewire.superadmin.includes.admin-navbar')
            </div>
            <!-- sidebar @e -->
            <!-- wrap @s -->
            <div class="nk-wrap ">
                                        ...
                                        <a href="#" class="dropdown-toggle me-n1" data-bs-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-xl-block">
                                                    <div class="user-status user-status-unverified">{{ Auth::user()->user_type }}</div>
                                            ...
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    <div class="user-avatar">
                                                        <span>{{ substr(Auth::user()->surname,0, 1). substr(Auth::user()->othernames,0, 1) }}</span>
                                                    </div>
                                                    <div class="user-info">
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2024 Marketwell Solutions
                            </div>
    ...
    <script src="{{ asset('assets/js/charts/chart-ecommerce.js?ver=3.1.3') }}"></script>
</body>
