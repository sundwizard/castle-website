														...
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 600px;"><img src="{{ asset('assets/images/grow/'.$grow->image) }}" alt="{{ asset('assets/images/grow/'.$grow->image) }}" style="display: block; height: auto; border: 0; width: 100%;" width="600"></div>
																</div>
															</td>
														</tr>
													</table>
