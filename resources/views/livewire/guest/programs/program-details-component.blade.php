<div>
    ...
    <x-slot name="logo">{{ asset('guest/images/uploads/'.$program->program_image)}}</x-slot>
    <x-slot name="description">{!! Str::limit(strip_tags($program->program_description), 100) !!}</x-slot>
    <x-slot name="title">{{ $program->program_title }}</x-slot>

    <div class="page-title-wrap typo-white">
        <div class="page-title-wrap-inner section-bg-img" data-bg="{{ asset('guest/images/uploads/'.$program->program_image)}}">
                ...
                <div class="row text-center">
                    <div class="col-md-12">
                        <div class="page-title-inner">
                            ...
                            <h1 class="page-title mb-0">{{ $program->program_title }}</h1>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="zoom-gallery">
                                            <div class="ministries-thumb relative margin-bottom-35">
                                                <img src="{{ asset('guest/images/uploads/'.$program->program_image)}}"
                                ...
                                <div class="row">
                                    <!-- Col -->
                                    <div class="col-md-12">
                                        <p class="margin-bottom-15">{!! $program->program_description !!}.</p>
                                    </div>
                                    <!-- Col -->
                                </div>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="media list-post">
                                                        ...
                                                        <div class="media-body">
                                                            <a
                                                                href="{{ route('programs.show',[str_replace("/","",$program->program_title),$program->id])}}">{{ $program->program_title }}</a>
                                                        </div>
                                                    </div>
                                                    <!-- Media End -->
                                                </li>
