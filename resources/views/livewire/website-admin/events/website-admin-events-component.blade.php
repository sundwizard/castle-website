<div>
    @include('livewire.website-admin.events.modals.view-event-modal')
                                    ...
                                    @foreach ($events as $event)
                                        <tr>
                                            ...
                                            <td class="desktopView">
                                                ...
                                                <img src="{{ asset('guest/images/uploads/'. $event->thumbnail) }}" class="rounded"  alt="" height="48">
                                                @else
                                                <img src="{{ asset('guest/images/uploads/'. $event->image) }}" class="rounded"  alt="" height="48">
                                                @endif
                                            </td>
                                            <td>{{ $event->event_title }}</td>
                                            <td class="desktopView">{!! Str::limit(strip_tags($event->description), 120) !!}</td>
                                            <td>{{ $event->event_date->format('Y-m-d')." ".$event->event_time->format('H:m') }}</td>
