<div>
    <x-slot name="title">Book Request</x-slot>
    ...
    <div class="page-content" >
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Book Requests</h4>
        ...
        <div class="row">
            <div class="col-lg-12" >
                <div class="card">
                    <div class="card-body">
                        <x-search-bar wire:model.live="searchTerm" placeholder="Search by request name or phoneno" />
                        <x-spin-loader />
                        <div>
                            <table class="table table-striped mb-0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th ><b>Image</b></th>
                                        <th class="desktopView"><b>Book Title</b></th>
                                        <th><b>Requested By</b></th>
                                        <th class="desktopView"><b>Email</b></th>
                                        <th  class="desktopView"><b>Phone no</b></th>
                                        <th><b>Status</b></th>
                                        <th><b>Action</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @foreach ($requests as $request)
                                        <tr>
                                            ...
                                            <td class="desktopView" scope="row">{{ $sn = $sn + 1 }}</td>
                                            <td>
                                                <img src="{{ asset('assets/images/ebooks/'.$request->book->cover) }}" class="rounded" alt="" height="48">

                                            </td>
                                            <td class="desktopView">{{ $request->book->title}}</td>
                                            <td>{{ $request->name}}</td>
                                            <td class="desktopView">{{ $request->email}}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown float-end"> <button  class="btn btn-success" data-bs-toggle="dropdown"  aria-expanded="false"><i class="mdi mdi-dots-vertical m-0 text-white h5"></i> </button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item confirm-delete" wire:click="setActionId('{{ $request->id }}')" href="#">Delete</a>
                                                    </div>
                                                </div>
