<div>
    <x-slot name="title">Nesletter Records</x-slot>
    @include('livewire.website-admin.newsletters.modals.view-newsletter-modal')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Sent Newsletter</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                            <li class="breadcrumb-item active">Sent Newsletter</li>
                        </ol>
                    </div>
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th  class="desktopView"><b>Date</b></th>
                                        <th><b>Action</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @foreach ($newsletters as $newsletter)
                                        <tr>
                                            ...
                                            <td  class="desktopView">{!! Str::limit(strip_tags($newsletter->description),120) !!}</td>
                                            ...
                                            <td>
                                                <div class="dropdown"> <button  class="btn btn-success" data-bs-toggle="dropdown"  aria-expanded="false"><i class="mdi mdi-dots-vertical m-0 text-white h5"></i> </button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#viewNewsletterModal" wire:click="setNewsletter({{ $newsletter }})" href="#">View</a>
                                                        {{-- <a class="dropdown-item" href="{{ route('grow.edit',$newsletter->id)}}">Edit</a> --}}
                                                        <a class="dropdown-item confirm-delete" wire:click="setActionId('{{ $newsletter->id }}')" href="#">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
