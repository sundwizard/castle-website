<div>
    <x-slot name="title">New Sponsor</x-slot>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">New Partner</h4>
        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                        <form name="new-blog" id="new-blog" wire:submit.prevent="newSponsor(Object.fromEntries(new FormData($event.target)))" enctype="multipart/form-data">
                            <div>
                                <div class="mb-3">
                                    <label class="form-label">Partner</label>
                                    <input class="form-control" wire:model="sponsor" type="text" placeholder="">
                                    @error('sponsor')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" wire:model="website" type="text" placeholder="">
                                    @error('website')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">
                                    <i wire:loading wire:target="newSponsor" class="bx bx-loader bx-spin font-size-16 align-middle me-2"></i> Submit
                                </button>
                        </form>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            //start cover photo
            let cropper;
            var finalCropWidth = 270;
            var finalCropHeight = 120;
