<div>
    <x-slot name="title">Growth Records</x-slot>
    @include('livewire.website-admin.grow.modals.view-growth-modal')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Grow with Mike</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                            <li class="breadcrumb-item active">grow</li>
                        </ol>
                    </div>
                                    ...
                                    @foreach ($growths as $growth)
                                        <tr>
                                            ...
                                            <td  class="desktopView">
                                                <img src="{{ asset('assets/images/grow/'.$growth->image) }}" class="rounded" alt="" height="48">

                                            </td>
                                            <td>{{ $growth->title}}</td>
                                            <td  class="desktopView">{!! Str::limit(strip_tags($growth->description),120) !!}</td>
                                            <td>
                                                <div class="dropdown"> <button  class="btn btn-success" data-bs-toggle="dropdown"  aria-expanded="false"><i class="mdi mdi-dots-vertical m-0 text-white h5"></i> </button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#viewGrothModal" wire:click="setGrowth({{ $growth }})" href="#">View</a>
                                                        <a class="dropdown-item" href="{{ route('grow.edit',$growth->id)}}">Edit</a>
                                                        <a class="dropdown-item confirm-delete" wire:click="setActionId('{{ $growth->id }}')" href="#">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
