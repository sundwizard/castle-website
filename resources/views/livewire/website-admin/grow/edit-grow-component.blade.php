<div>
    <x-slot name="title">Grow with mike post modificatiob</x-slot>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Grow with Mike Modification</h4>
        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                        <form name="new-blog" id="new-blog" wire:submit.prevent="updateBlog(Object.fromEntries(new FormData($event.target)))" enctype="multipart/form-data">
                            <div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <img src="{{ asset('assets/images/grow/'.$selGrowth->image)}}" class="rounded" alt="" height="48">
                                        </div>
                                        <div class="col-md-10">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">
                                    <i wire:loading wire:target="updateBlog"
