<div>
    {{-- @include('livewire.website-admin.teams.modals.view-team-modal') --}}
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Team</h4>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($teams as $team)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset('assets/images/team/'.$team->image) }}" class="rounded-circle avatar-xs m-1" alt=""></td>
                                            <td>{{ $team->full_name}}</td>
                                            <td>{{ Str::limit($team->about,100)}}</td>
                                            <td>{{ $team->role}}</td>
                                            <td>
                                                ...
                                                <div class="dropdown float-end"> <button  class="btn btn-success" data-bs-toggle="dropdown"  aria-expanded="false"><i class="mdi mdi-dots-vertical m-0 text-white h5"></i> </button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#viewteamModal" wire:click="setteam({{ $team }})" href="#">View</a>
                                                        <a class="dropdown-item confirm-delete" wire:click="setActionId('{{ $team->id }}')" href="#">Delete</a>
                                                    </div>
                                                </div>
