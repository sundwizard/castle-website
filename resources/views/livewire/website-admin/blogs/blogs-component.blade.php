<div>
    <x-slot name="title">Blog Records</x-slot>
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th  class="desktopView"><b>Blog Description</b></th>
                                        <th><b>Action</b></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    @foreach ($blogs as $blog)
                                        <tr>
                                            ...
                                            <td  class="desktopView">
                                                <img src="{{ asset('assets/images/blogs/'.$blog->image) }}" class="rounded" alt="" height="48">

                                            </td>
                                            <td>{{ $blog->blog_title}}</td>
                                            <td  class="desktopView">{!! Str::limit(strip_tags($blog->description),120) !!}</td>
                                            <td>
                                                <div class="dropdown"> <button  class="btn btn-success" data-bs-toggle="dropdown"  aria-expanded="false"><i class="mdi mdi-dots-vertical m-0 text-white h5"></i> </button>
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#viewBlogModal" wire:click="setBlog({{ $blog }})" href="#">View</a>
                                                        <a class="dropdown-item" href="{{ route('blogs.edit',$blog->id)}}">Edit</a>
                                                        <a class="dropdown-item confirm-delete" wire:click="setActionId('{{ $blog->id }}')" href="#">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
