<div>
    <x-slot name="title">Blog post modification</x-slot>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Blog Post modificaiton</h4>
                        ...
                        <form name="new-blog" id="new-blog" wire:submit.prevent="updateBlog(Object.fromEntries(new FormData($event.target)))" enctype="multipart/form-data">
                            <div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <img src="{{ asset('assets/images/blogs/'.$selBlog->image)}}" class="rounded" alt="" height="48">
                                        </div>
                                        <div class="col-md-10">
