<div>
    <x-slot name="title">Event Modification</x-slot>
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="page-title mb-0 font-size-18">Event Modification</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                            <li class="breadcrumb-item active">Event Modificatio</li>
                        </ol>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-body">
                        <form name="new-event" id="new-event" wire:submit.prevent="updateEvent(Object.fromEntries(new FormData($event.target)))" enctype="multipart/form-data">
                            <div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" aria-label="Default select example" wire:model="type_of_event">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            @if ($file_extension == 'jpg' || $file_extension == 'png' || $file_extension == 'jpeg')
                                                <img src="{{ getImage().$selEvent->image }}" class="rounded" alt="" height="48">
                                            @elseif ($file_extension =='mp4' || $file_extension =='avi' || $file_extension =='mov')
                                            <button type="submit" class="btn btn-success waves-effect waves-light">
                                                <i class="bx bx-loader bx-play font-size-16 align-middle me-2"></i> Play
                                            </button>
                                            @endif
                                        </div>
                                        <div class="col-md-10">
                                ...
                                <div class="mb-3" @if(!$isVideo) style="display: none" @endif>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <img src="{{ getImage().$selEvent->thumbnail }}" class="rounded" alt="" height="48">
                                        </div>
                                        <div class="col-md-10">
                                            <div class="custom-file">
                                                <div x-data="{ isUploading: false, progress: 5 }" x-on:livewire-upload-start="isUploading = true"
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">
                                    <i wire:loading wire:target="updateEvent"
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            var ThumbnailfinalCropWidth = 1250;
