...
class EditSermonComponent extends Component
{
    ...
    public function mount($id){
        $this->selSermon = $sermon = Sermon::find($id);
    ...
    public function updateSermon($formData)
    {
        $this->validate([
        ...
        if($this->photo){
            ...
            unlink('assets/images/sermons/'.$this->selSermon->image);
            ...
            $this->selSermon->update(['image'=>$blogImageName ]);
        }

        $this->selSermon->update([
            'title' => $this->title,
        ...
        return redirect()->route('sermons.index')->with('feedback','Sermon updated successfully');
    }


    public function render()
    {
        return view('livewire.website-admin.sermons.edit-sermon-component')->layout('livewire.website-admin.layouts.app');
    }
}
