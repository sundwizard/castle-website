...
class NewEventComponent extends Component
{
    ...
    public function uploadProductImage($image){
        ...
        Storage::disk('do')->put(storePhoto().$postImage, $img->stream()->__toString(), 'public');
    ...
    public function newEvent($formData)
    {
        ...
        if ($this->isImage($fileExtension)) {
            ...
            $this->photo->storePubliclyAs(storePhoto(),$eventImageName,'do');
    ...
    {
        return view('livewire.superadmin.events.new-event-component');
    }
}
